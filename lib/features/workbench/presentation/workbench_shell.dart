    ...
    return ListenableBuilder(
      ...
      builder: (context, _) {
        ...
        return switch (active) {
          WorkCollectibleTab(:final item, :final isDirty) => WorkDetailWorkspace(
              ...
              onBindSave: (save) => widget.controller.saveActiveTab = save,
              ...
              onPendingEntityLinkHandled: widget.onPendingWorkEntityLinkHandled,
