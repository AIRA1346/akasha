...
void main() {
  ...
  group('Phase 6 — Global Library Autoloading & Status Borders Tests', () {
    test(
      'On-Demand Fusion merges local vault items with registry templates correctly',
      () {
        ...
        final minecraftId = WorksRegistry.getWorkById(
          'gen_game_minecraft_2011',
        )!.workId;
        final lolId = WorksRegistry.getWorkById(
          'gen_game_league-of-legends_2009',
        )!.workId;
        final axiomId = WorksRegistry.getWorkById(
          'gen_game_axiom_2024',
        )!.workId;
        ...
        expect(elden.myStatusLabel, 'Cleared');

        final minecraft = fusedList.firstWhere((e) => e.workId == minecraftId);
        expect(minecraft.myStatusLabel, 'Backlog');
