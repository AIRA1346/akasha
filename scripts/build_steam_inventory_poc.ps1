...
Write-Host "  $appid"
Write-Host ""
Write-Host "Launch with Steam running. POC: App Preferences → Steam Inventory POC (debug),"
Write-Host "or verify native initialize via harness when dart-define is set."
