...
/// akasha-db ?§ÎìúÎ•?v3 Î©îÌ??∞Ïù¥?∞Î°ú ?êÏßÑ ÎßàÏù¥Í∑∏Î†à?¥ÏÖò
///
/// - `titles` ?ÜÏúºÎ©??àÍ±∞??`title`?êÏÑú Ï∂îÏ†ï
/// - `extensions`??anilist/steam/isbn ??`externalIds` ?πÍ≤©
/// - `title`?Ä ?†Ï? (?òÏúÑ ?∏Ìôò¬∑?ïÎ†¨)
///
/// Usage:
///   dart run tool/migrations/migrate_registry_v3.dart
