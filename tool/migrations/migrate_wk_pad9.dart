...
// Í∏∞Ï°¥ 8?êÎ¶¨ `wk_` ??9?êÎ¶¨ canonical ?ïÏãù ?ºÍ¥Ñ Î≥Ä??///
// Usage:
//   dart run tool/migrations/migrate_wk_pad9.dart
//   dart run tool/migrations/migrate_wk_pad9.dart --apply --sync-assets
//
// `wk_00000402` ??`wk_000000402` (?úÎ≤à¬∑legacy Îß§Ìïë ?†Ï?)
...
void _applyLegacyAliases(Directory root, Map<String, String> remap) {
  ...
  // Î≥ºÌä∏??Íµ?8?êÎ¶¨ wk_Í∞Ä ?®ÏïÑ ?àÏñ¥??9?êÎ¶¨Î°??¥ÏÑù
