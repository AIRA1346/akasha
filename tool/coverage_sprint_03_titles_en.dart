...
void main(List<String> args) async {
  ...
  print('  enriched: $successCount/$_milestoneCount (auto $autoOk · semi $semiOk · manual $manualOk · fail $failed)');
  ...
  print('  wall vs estimate: ${economics['deltaWallVsEstimateMinutes']} min · human-eq vs estimate: ${economics['deltaHumanEquivalentVsEstimateMinutes']} min');
  print('  titles.en: ${coverage['titles_en_after']}');
  print('  SW1: ${regression['sw1_recallAt10']} · URV: ${regression['urv_convergence']}');
