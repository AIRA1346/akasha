...
> **지위:** AKASHA **제품·아카이빙 북극성 SSOT** — Fact 사전·카탈로그 확장·Memory Core와 **분리**  
> **갱신:** 2026-06-14  
> **상위:** [product-vision.md](../product-vision.md) (Tier 1/2 · Steam v1 **현재 구현 범위**)  
> **인프라·규모:** [data-architecture-redesign.md](../strategy/data-architecture-redesign.md) · **레이어:** [ADR-007](../adr/ADR-007-app-layering.md)
...
| **작품** | 프리렌 · 바이올렛 · 엘든링 | **✅** |
| **인물** | 성우 · 작가 · 뉴턴 | 📋 |
| **사건·개념·현상** | 2차대전 · 진화론 · 블랙홀 | 📋 |
| **일기·일상·생각·아이디어** | 「문득 AI와 인간은…」 | 📋 |
| **가치관·창작·취향** | 기획 메모 · 세계관 · 큐레이션 | 📋 |
...
| 문서 | 역할 |
|------|------|
| **본 문서** | 궁극 아카이빙 **제품 SSOT** |
| [product-vision.md](../product-vision.md) | Tier 1/2 · **v1 Steam In/Out** |
...
**실행 SSOT:** [architecture-evolution-phases.md](../programs/architecture-evolution-phases.md)
