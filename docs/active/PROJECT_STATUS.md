...
| **Home UI** | **UX-3A/B/C** ✅ · **UX-4A/B/C Preview+destination roles** ✅ · honest CTA · responsive Preview · Explore/Library/Collections 역할 분리 |
...
|--------|:----:|:-----------:|------|
| **G-AUTO** | ✅ | ✅ | app **1115** · domain **14** · backend **17** · analyze **0** · release build **PASS** |
