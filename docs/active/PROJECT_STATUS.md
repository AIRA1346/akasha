...
> self-describing Vault-spec sync remain in place. `flutter analyze lib
> --no-pub` **0 issues**, full `flutter test --no-pub` **916 passed**, and
> `flutter build windows --debug --no-pub` succeeded.
