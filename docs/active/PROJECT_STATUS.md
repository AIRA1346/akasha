...
> **갱신:** 2026-06-24 (@10048 · Foundation Phase 2 · P22 dashboard R14-B + P23 AppVault)  
...
**대형 파일 (2026-06-26):** `entity_detail_workspace` **278** · `work_detail_workspace` **273** · `poster_card_layouts` **~270** (P24 분해)
