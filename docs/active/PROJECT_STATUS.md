...
| **Commerce UX 기반** | Steam Inventory authority SSOT · 공식 테마 패키지 3종 · `CommerceGateway`/nullable snapshot · read-only Store & Inventory · fake zero/혼합결제/재화교환 금지 ✅ |
...
| 2026-07-15 | **Commerce catalog foundation** — Astra/Echo·Steam Inventory authority SSOT · launch theme package 3종 500/500 choose-one · mixed/convert 금지 · official catalog에서 demo SKU 제거 · nullable account snapshot/gateway · read-only Store & Inventory · 1024×720/125% 검증 · full tests **1132 PASS** · domain **16 PASS** · analyze **0** |
