...
| **Home UI** | **UX-3A/B/C** ✅ · **UX-4A/B Preview hierarchy+density** ✅ · honest CTA · 288 rail · capped compact sheet · semantic Preview surfaces |
...
|--------|:----:|:-----------:|------|
| **G-AUTO** | ✅ | ✅ | app **1110** · domain **14** · backend **17** · analyze **0** · release build **PASS** |
