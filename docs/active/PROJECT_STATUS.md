...
| **Commerce UX 기반** | Steam Inventory authority SSOT · 공식 테마 패키지 3종 · production ItemDef registry/read gateway · app-root controller/scope · Store/Inventory/theme access 단일 snapshot · Astra pack/theme section · loading/offline/retry/owned · compact/125% text · POC ID 무시 · fake zero/혼합결제/재화교환 금지 ✅ |
