...
> **갱신:** 2026-06-29 (@10048 · Foundation Phase 2 · **P30** collectible dialog 분해 · `origin/main` **9d17f75**)
...
| **다음** | **Foundation Phase 2** — `work_library_panel` 분해 · dialog 저장 widget test (P30 후속) |
...
| **Foundation P2** | `work_library_panel` 분해 · P30 dialog widget test | **P0** |
| **Scale/Core** | **보류** | — |
...
**대형 파일 (2026-06-29 재실측 · Post-P30):** `markdown_body_editor` **503** (shell + parts) · `home_shell_body` **479** · `work_library_panel` **466** · `franchise_fusion_service` **456** · `home_dialogs_coordinator` **435** · `home_shell_scaffold` **428**

**P27~P30 분해 완료 (shell 줄 수):** `dashboard_sidebar` **152** · `browse_dashboard_sections` **165** · `collectible_collection_edit_dialog` **73** · `poster_card_layouts` **~270** (P24) · markdown editor 6 parts (P26)
...
| # | 작업 | 우선 |
|---|------|:----:|
| 1 | `work_library_panel.dart` 분해 (P31) | **P0** |
| 2 | `collectible_collection_edit_dialog` 저장 플로우 widget test (P30 후속) | P1 |
| 3 | `home_shell_scaffold` · `home_dialogs_coordinator` · `franchise_fusion_service` 분해 | P2 |
