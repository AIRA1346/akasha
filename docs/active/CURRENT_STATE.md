...
> **2026-07-12 verification:** P1 local `candidate.create` Gateway slice, candidate provenance review UX, Vault-spec self-description sync, `flutter analyze lib --no-pub` **0 issues**, full `flutter test --no-pub` **899 passed**.
