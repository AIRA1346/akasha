...
- **수동 dogfood 잔여 (P1-10 carry-forward):** Release 빌드에서 사이드바·프리뷰·다이얼로그의 대비·가독성을 공식 5테마별로 한 번씩 확인한다. 역사적 관찰 원문은 [AGENT_VAULT_UI_DOGFOOD_REVIEW.md](../history/closure-2026-07/ux-discovery/AGENT_VAULT_UI_DOGFOOD_REVIEW.md)에 고정한다.
