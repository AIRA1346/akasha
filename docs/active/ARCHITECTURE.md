...
**초기 430작 Registry 마일스톤은 시작점일 뿐이었다.** 현행 full-bundle 규모는 위 헤더를 따른다.
...
| 시점 | 레지스트리 작품 수 | 운영 모델 |
|------|-------------------|-----------|
| **2026** (Steam v1) | 초기 ~430 엄선 마일스톤 → full-bundle 전환 | v4 런타임(`wk_`·해시 샤드) + 번들 |
...
| 「엄선 레지스트리」= 최종 정체성 | **전 작품 사전**이 목표; 430작은 **초기 엄선 마일스톤** |
