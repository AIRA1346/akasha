...
### AI/Agent 경계 (2026-07-03)

"에이전트와 함께 기록한다"는 말은 AKASHA가 AI 서비스, 채팅 동반자, 플레이어, 도구 오케스트레이터가 된다는 뜻이 아니다.

AKASHA의 역할은 **사용자의 vault와 취향 증거를 오래 보존하고, 외부 도구/AI가 읽고 쓸 수 있는 안정적인 아카이브 구조를 제공하는 것**이다. 예를 들어 외부 에이전트가 "내가 좋아하는 액션영화 OST 틀어줘"라는 요청을 처리할 때, AKASHA는 취향 근거와 연결 정보를 제공하고 실제 음악 재생은 외부 도구가 담당한다.

무한 확장을 위한 실행 계획은 [INFINITE_ARCHIVE_HARDENING_PLAN.md](INFINITE_ARCHIVE_HARDENING_PLAN.md)를 따른다.
...
| [AKASHA_VAULT_FORMAT_SPECIFICATION_V3.md](AKASHA_VAULT_FORMAT_SPECIFICATION_V3.md) | **Vault 형식 명세 v3** — 영원성·구조·소유의 공식 계약 (vault 동봉 · 독립 검증기) |
| [ultimate-archiving-vision.md](../history/product/ultimate-archiving-vision.md) | **궁극적 아카이빙** — Entity+Timeline · Phase 1~4 |
| [INFINITE_ARCHIVE_HARDENING_PLAN.md](INFINITE_ARCHIVE_HARDENING_PLAN.md) | 무한 vault 확장을 위한 index · taste signal · agent write · ID path 계획 |
| [ULTIMATE_ARCHIVE_PRE_RELEASE_ARCHITECTURE_AUDIT.md](ULTIMATE_ARCHIVE_PRE_RELEASE_ARCHITECTURE_AUDIT.md) | 출시 전 Vault Layout v3 canonical 전환 후보 감사 |
...
| 2026-07-03 | **Infinite Archive Hardening** — AKASHA는 AI 서비스가 아니라 외부 도구/AI가 읽을 수 있는 궁극의 아카이브 기반층 |
| 2026-07-03 | **Pre-release Architecture Audit** — Vault Layout v3 canonical 후보: ID path · operation contract · candidate/taste index |
