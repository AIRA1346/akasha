...
- 대시보드 · IP 1카드 · 나만의 서재 · 번들 무료 앱 테마 2종(Classic Dark, Midnight Blue)
...
| 번들 무료 테마 2종 · 나만의 서재 정리 | Premium 테마 3종(Sakura, Amethyst, Nocturne) 판매 활성 · TMDB/IGDB 자동 메타·포스터 연동 **제외** (`externalIds.*`만 유지) |

**akasha-db:** 삭제하지 않음 — optional catalog · CI 자산 · post-v1 scale track.

**Steam 출시:** 사용자 지시에 따라 무료 일반 출시로 진행. Premium 테마 3종의 상품 계획은 확정하지만 판매 시점·가격·production IAP 활성화는 commerce gate 이후 별도 Go로 결정한다.
...
| [ULTIMATE_ARCHIVE_PRE_RELEASE_ARCHITECTURE_AUDIT.md](../history/closure-2026-07/ULTIMATE_ARCHIVE_PRE_RELEASE_ARCHITECTURE_AUDIT.md) | 출시 전 Vault Layout v3 감사 |
...
| [UX_DESIGN_SYSTEM.md](UX_DESIGN_SYSTEM.md) | IA · Shell · 컴포넌트 · 테마 표현 계약 |
