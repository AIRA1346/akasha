...
> **갱신:** 2026-06-25
> **상위:** [PROJECT_STATUS.md](PROJECT_STATUS.md) · [STEAM_EARLY_ACCESS.md](STEAM_EARLY_ACCESS.md)
...
**SSOT:** [AGENT_VAULT_PROTOCOL_V1.md](AGENT_VAULT_PROTOCOL_V1.md) §8 · **Work slice:** [AGENT_VAULT_LOOP_SLICE.md](AGENT_VAULT_LOOP_SLICE.md) · **금지:** registry manifest 4파일 · M3 출시 착수.
...
| 2026-06-30 | §3.4 Agent vault 루프 A1~A10 · [AGENT_VAULT_PROTOCOL_V1.md](AGENT_VAULT_PROTOCOL_V1.md) |
