...
| ~~SD2.6~~ | ~~410→430 +20 상한~~ | **폐기 (2026-06-10)** — [catalog-growth-charter.md](catalog-growth-charter.md) |
...
| SD4.6 | 거버넌스 **정기 스냅샷** | `a5_scale_governance_observation` — insert **후**·주 1회 |
| SD4.7 | O3 **텔레메트리** | `a5_scale_o3_checkpoint` — insert **허용/거부 스위치 아님** |
...
| 2026-06-10 | **SD2.6 폐기** — catalog-growth-charter · O3 재정의 |
