...
| # | 단계 | 확인 | 메모 |
|:-:|------|:----:|------|
| 1 | **① 발견** — 검색 또는 browse에서 작품 찾기 | ☐ | |
| 2 | **② 아카이브** — `.md` 생성 (수동 또는 auto-archive) | ☐ | |
| 3 | **③ 기록** — 워크벤치 저장 · 감상/인용 입력 | ☐ | |
| 4 | **④ 큐레이션** — 나만의 서재·라이브러리 멤버십 확인 | ☐ | |

### 글로벌 사전 (대시보드) friction

| 일자 | friction | 심각도 | 조치 |
|------|----------|:------:|------|
| 2026-06-15 | 초기 로딩 느림 · `48/5181`과 실제 표시 수(854→1700) 불일치 | annoying | browse window UX |
| 2026-06-15 | 매체(만화·애니) 하위 접기 없음 | annoying | ✅ 카테고리 접기 구현 |
| 2026-06-15 | 대시보드에 감상 예정 보관함 — 글로벌 탐색과 역할 겹침 | annoying | v1.1 검토 |
