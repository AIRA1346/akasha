...
> **다음:** [archive-first-dogfood-checklist.md](archive-first-dogfood-checklist.md) (R5) · ADR-013 ✅ · Wave 6 검토
...
| E2E dogfood | ⏳ | **R5 Gate** — Archive-First checklist |
...
| Work → Person/Concept dogfood | ⏳ | archive-first-dogfood-checklist (R5) |
...
| # | 항목 | 우선 |
|---|------|------|
| R-W5-1 | Dogfood 1회 | **R5 Gate** (R1 후) |
| R-W5-2 | ADR-013 Link Index | ✅ |
| R-W5-3 | Incremental index (single-file) | optional |
| R-W5-4 | sameDay sidebar | ✅ W5-5 |
| R-W5-5 | titleOnly → fusion search fallback | enhancement |
| R-W5-6 | **Archive-First UX debt** | [wave4-exit-review §4](wave4-exit-review.md) → R1 |
...
| 2026-06-19 | **v1.1** — R5 dogfood pointer · W5-5/ADR-013 status · UX debt |
