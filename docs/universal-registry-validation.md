...
| S3 | 애니 1기/2기는 [canonicalization-policy](canonicalization-policy.md)대로 **동일 wk_** 인가? |
...
**현재 전략** ([canonicalization-policy](canonicalization-policy.md))
...
| 산출물 | 경로 | 상태 |
|--------|------|------|
| 본 검증 계획 | `docs/universal-registry-validation.md` | ✅ |
