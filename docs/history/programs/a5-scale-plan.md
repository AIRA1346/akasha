...
> **2026-06-10 갱신:** SD2.6 insert hold **폐기** — [catalog-growth-charter.md](catalog-growth-charter.md).  
> O3·O8은 **텔레메트리** — insert와 **병행**. 본 문서의 “Pause/관측”은 **품질 회귀 시**만 적용.

**문서 성격:** Scale **계획** — 목표·관측·전략·Gate 조건 정의.
...
[a5-gate-review.md]](../archive/a5-gate-review.md) §3 · Pilot Gate Record를 Scale에 **적용**한다. Pilot 판정은 **변경하지 않는다**.
...
| [a5-gate-review.md]](../archive/a5-gate-review.md) | S1~S5 · Stop/Pause/Continue |
| [a5-question-register.md]](../archive/a5-question-register.md) | O1~O14 · Scale 시점 |
