...
> **기준일:** 2026-06-10 · 앱 버전: v1 (Windows) · 카탈로그 **490작**
...
```
Sanctum 볼트와 연동하는 개인 미디어 아카이브. 엄선 글로벌 작품 사전(490+)과 IP 1카드 그리드, 나만의 서재로 만화·애니·게임·영화 기록을 한곳에.
```

### English

```
Personal media archive linked to your Sanctum vault. Curated global work catalog (490+), IP fusion grid, and My Library for manga, anime, games, and film — all in local Markdown you own.
```
...
• 글로벌 작품 사전 — 490+ 엄선 작품, GitHub 동기화, 포스터 없는 Fact 카드
• 작품 검색 — 내 볼트 + 사전 + 직접 등록
...
• Global work catalog — 490+ curated titles, GitHub sync, poster-free fact cards
...
| # | 화면 | 촬영 방법 | 스토어 메시지 |
|---|------|-----------|---------------|
| 1 | **홈 대시보드** | 포스터 없는 Fact 카드 · 카테고리 플레이스홀더 | 「490+ 텍스트 카탈로그」 |
...
- [x] Privacy policy — [docs/policy/privacy.md](../policy/privacy.md) (Steam URL: GitHub Pages 또는 raw link)
