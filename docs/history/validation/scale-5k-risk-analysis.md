...
>
> **범위:** [Baseline v1]](../strategy/baseline-v1.md) 고정 후 첫 검증 (Growth 단계 **G0→G1**).  
> 구현 없음 — 리스크 평가 + 검증 계획만.

선행: [registry-growth-strategy.md]](../strategy/registry-growth-strategy.md) §6 · [registry-bottleneck-validation-report.md](registry-bottleneck-validation-report.md) · [contribution-model-strategy.md](contribution-model-strategy.md) · [assumption-register.md](assumption-register.md) (A1~A4)
