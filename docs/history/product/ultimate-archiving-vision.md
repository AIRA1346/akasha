...
> **인프라·규모 (historical):** `data-architecture-redesign.md` (당시 경로 · 현재 문서: [ARCHITECTURE.md](../../active/ARCHITECTURE.md)) · **레이어:** [ADR-007](../adr/ADR-007-app-layering.md)
...
**v1 Steam: ①~④.** ⑤는 Phase 2~4와 맞물림 ([ROADMAP.md §v1.1+](../../active/ROADMAP.md)).
...
| `data-architecture-redesign.md` §7 (당시 경로 · 현재 문서: [ARCHITECTURE.md](../../active/ARCHITECTURE.md)) | 인프라·융합 |
