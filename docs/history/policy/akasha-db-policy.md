...
**장기 비전:** 세상의 **모든 작품 사전** — `data-architecture-redesign.md` (당시 경로 · 현재 문서: [ARCHITECTURE.md](../../active/ARCHITECTURE.md))
...
| **이 문서** | 사전 **구축·운영** |
| `data-architecture-redesign.md` (당시 경로 · 현재 문서: [ARCHITECTURE.md](../../active/ARCHITECTURE.md)) | v2 아키텍처·ADR |
