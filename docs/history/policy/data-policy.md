...
| `domain` | Fact (deprecated) | ✅ | **`subculture` only** — `generalCulture` 제거 ([DOMAIN_DEPRECATION_PLAN](../closure-2026-07/DOMAIN_DEPRECATION_PLAN.md) · historical; compatibility: [LEGACY_REMOVAL_POLICY](../../active/LEGACY_REMOVAL_POLICY.md) §4b) |
