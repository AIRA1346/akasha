...
### Sprint 04 — externalId G2

**SSOT (현재):** [sprint-04-document-reconciliation.md](sprint-04-document-reconciliation.md) · [sprint-04-baseline-report.md](sprint-04-baseline-report.md) · [project-status-snapshot.md](project-status-snapshot.md) (@430)
