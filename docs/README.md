...
- [DOMAIN_DEPRECATION_PLAN.md](history/closure-2026-07/DOMAIN_DEPRECATION_PLAN.md) — completed domain deprecation plan
- [STEAMPIPE_COMMERCE_SANDBOX_UPLOAD.md](history/closure-2026-07/STEAMPIPE_COMMERCE_SANDBOX_UPLOAD.md) — historical commerce sandbox upload preparation
