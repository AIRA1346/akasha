...
2026-07-19 위생 분류 후 잔류 draft (4):

| 문서 | 비고 |
|---|---|
| [Ultimate Archive Backlog](draft/ULTIMATE_ARCHIVE_BACKLOG.md) | Non-binding draft backlog |
| [Canvas Editor Decomposition Plan](draft/CANVAS_EDITOR_DECOMPOSITION_PLAN.md) | Open B1–B6 plan |
| [Agent Vault UI Dogfood Review](draft/AGENT_VAULT_UI_DOGFOOD_REVIEW.md) | Open checklist |
| [akasha-db Ownership Audit](draft/AKASHA_DB_OWNERSHIP_AUDIT.md) | A/B/C decision pending |
...
- [closure-2026-07/ux-discovery](history/closure-2026-07/ux-discovery/README.md) — UX Recovery / R3–R5 / R14
