...
> [registry-growth-strategy.md]](../strategy/registry-growth-strategy.md)의 파이프라인 중심 성장에 **커뮤니티·사용자 등록** 역할을 명시한다.

선행 문서:

- [registry-growth-strategy.md]](../strategy/registry-growth-strategy.md) — G0~G4 · Long Tail tier
...
- 5M은 [registry-growth-strategy]](../strategy/registry-growth-strategy.md)의 **한 단계**이지 **최종 상한이 아님**.
...
| enrich SLA 수치 | [registry-growth-strategy]](../strategy/registry-growth-strategy.md) |
