...
> **전제:** [phase2-mid-review.md](archive/phase2-mid-review.md) · Sprint 01~03 실측 · [phase2-late-stage-plan.md](archive/phase2-late-stage-plan.md) **P0**  
...
> Sprint 01~03 · remediate · [phase2-mid-review.md](archive/phase2-mid-review.md) §3.2 근거. **가설·신규 실험 없음.**
...
| I4 | **stub 희석 감시** | 수동·주기 | G1 insert 시 Coverage rate **하락** 추적 (A2 — [phase2-late-stage-plan](archive/phase2-late-stage-plan.md)) |
...
| [phase2-late-stage-plan.md](archive/phase2-late-stage-plan.md) | P0 QA 검증 질문 |
| [phase2-mid-review.md](archive/phase2-mid-review.md) | Sprint 03 품질 리스크 근거 |
