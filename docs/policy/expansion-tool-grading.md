...
> **이유:** v3 샤드 경로(`animation_A.json` 등) 또는 gate 없음 · dedupe 오염 위험  
> **2026-06-10:** D급 도구 **저장소에서 제거** — 실수 실행 방지.

| 도구 | 조치 |
|------|------|
| ~~`seed_expansion.dart`~~ | **삭제** |
| ~~`seed_expansion_batch3.dart`~~ | **삭제** |
| ~~`seed_expansion_batch4.dart`~~ | **삭제** |
...
| 2026-06-10 | D급 seed_expansion batch2~4 **삭제** |
