...
| 순위 | 과제 | 문서 |
|------|------|------|
| 1 | `wk_` 영구 ID | [data-architecture-redesign.md](data-architecture-redesign.md) |
| 2 | canonicalization·dedupe | [canonicalization-policy.md](canonicalization-policy.md) |
| 3 | 해시 샤딩 | SCHEMA v4 |
