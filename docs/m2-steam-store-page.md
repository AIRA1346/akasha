...
• 글로벌 작품 사전 — 430+ 엄선 작품, GitHub 동기화, IP당 1카드 그리드
• 작품 검색 — 내 볼트 + 사전 + 직접 등록
...
■ 데이터는 내 것
글로벌 사전은 메타데이터 참조용입니다. 아카이브한 작품만 볼트에 .md 파일이 생성됩니다.
...
• Global work catalog — 430+ curated titles, GitHub sync, one card per IP
...
■ You own your data
The catalog is reference metadata. Only works you archive become .md files in your vault.
...
| # | 화면 | 촬영 방법 | 스토어 메시지 |
|---|------|-----------|---------------|
| 1 | **홈 대시보드** | `master_index` · IP 1카드 그리드 · 필터 칩 | 「430+ 작품 카탈로그」 |
| 2 | **작품 검색** | 검색 다이얼로그 · 사전+볼트 결과 | 「로컬 + 글로벌 검색」 |
| 3 | **작품 상세** | 포스터·매체 칩·메타 | 「IP 1카드 · 매체 칩」 |
| 4 | **나만의 서재** | 사이드바 `나만의 서재` · 아카이브 그리드 | 「내 아카이브만 모아 보기」 |
